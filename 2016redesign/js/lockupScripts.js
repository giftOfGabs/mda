...
var eventType = 'Lock-Up';
var viewportWidth = $(window).width();

$(document).ready(function(){    
    [[?[[?[[S8]]::splash::T::]][[?[[S8]]::front::T::]]::T::
        instagramFeed();
        [[?[[S151:lockup_feature_1]]::TRUE::
...
function instagramFeed(){
    if (viewportWidth < 568) {
        var feedFrame = '<iframe src="https://snapwidget.com/in/?h=bWRhbG9ja3VwfGlufDEyNXwxfDN8fG5vfDV8bm9uZXxvblN0YXJ0fHllc3x5ZXM=&ve=211215" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%;"></iframe>';
        $(feedFrame).appendTo('.instagramFeed');

    }else{
        var feedFrame = '<iframe src="https://snapwidget.com/in/?h=bWRhbG9ja3VwfGlufDEyNXw2fDJ8fG5vfDV8bm9uZXxvblN0YXJ0fHllc3x5ZXM=&ve=211215" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%;"></iframe>';
        $(feedFrame).appendTo('.instagramFeed');
    }
...
function noResults() {
    var error = '<p class="upcoming">Your search returned no results. Please try another search by zip code or state to see what MDA Lock-Up events are happening in your community.</p>';
     $(error).appendTo('.searchResults .container .results');
}
function noGeo() {
    var error = '<p class="upcoming">Search by zip code to see what MDA Lock-Up events are happening in your community.</p>';
     $(error).appendTo('.searchResults .container .results');
}
