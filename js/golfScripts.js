...
function noGeo() {
    var error = '<p class="upcoming">Search by zip code to see what MDA Golf events are happening in your community.</p>';
     $(error).appendTo('.searchResults .container .results');
}
