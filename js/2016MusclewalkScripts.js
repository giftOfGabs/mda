...
var eventType = 'Muslce Walk';
var viewportWidth = $(window).width();

$(document).ready(function(){    
    [[?[[?[[S8]]::splash::T::]][[?[[S8]]::front::T::]]::T::
        instagramFeed();
        [[?[[S151:musclewalk_feature_1]]::TRUE::
    ...
    [[?[[?[[S8]]::splash::T::]][[?[[S8]]::front::T::]][[?[[S8]]::events::T::]][[?[[S8]]::mw_search::T::]]::T::
        [[?[[S8]]::theZip::
...
function instagramFeed(){
    if (viewportWidth < 568) {
        var feedFrame = '<iframe src="https://snapwidget.com/in/?h=bXVzY2xld2Fsa3xpbnwyMDB8MXwzfHxub3w1fG5vbmV8b25TdGFydHx5ZXN8eWVz&ve=021215" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%;"></iframe>';
        $(feedFrame).appendTo('.instagramFeed');

    }else{
        var feedFrame = '<iframe src="https://snapwidget.com/in/?h=bXVzY2xld2Fsa3xpbnwxMDB8NnwyfCM0ODVjYzd8bm98NXxmYWRlT3V0fG9uU3RhcnR8eWVzfHllcw==&ve=171115" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%;"></iframe>';
        $(feedFrame).appendTo('.instagramFeed');
    }
...
function noGeo() {
    var error = '<p class="upcoming">Search by zip code to see what MDA Muscle Walk events are happening in your community.</p>';
     $(error).appendTo('.searchResults .container .results');
}
